...
<html lang="en">
  <head>
    <title><?php echo $sitename; ?> - Cnetwork</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <main>
      <div class="container">
        ...
        <section id="content">
          <div class="info">
            ...
            <div id="how" class="area">
              ...
              <pre class="links">
              &lt;img src="<a href="//img.static.my.id/300x300" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300" target="_blank"></a>"&gt;
              </pre>
              ...
              <pre class="links">
              &lt;img src="<a href="//img.static.my.id/300/ccc" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc/999" target="_blank"></a>"&gt;
              </pre>
              ...
              <pre class="links">
              &lt;img src="<a href="//img.static.my.id/300.png/ccc/999" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc.gif/999" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc/999.jpg" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc.jpeg/999" target="_blank"></a>"&gt;
              </pre>
              <h2>Custom Text</h2>
              ...
              <pre class="links">
              &lt;img src="<a href="//img.static.my.id/300&text=custom+text" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc&text=custom+text" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc/999&text=custom+text" target="_blank"></a>"&gt;
              &lt;img src="<a href="//img.static.my.id/300/ccc.gif/999&text=custom+text" target="_blank"></a>"&gt;
              </pre>
            </div>
            ...
            <div id="examples" class="area">
              ...
              <div class="grid">
                <div class="item"><img src="//img.static.my.id/300" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300/090/fff.jpeg" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300x300" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300/000" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300/f60/000" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300&text=custom+text" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300.png/f00/fff" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300/ccc.gif/000" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300/fc0/000.jpg" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300x300/f60/000" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300.jpg/666/fff&text=custom+text" alt=""></div>
                <div class="item"><img src="//img.static.my.id/300x300/cccccc/999999" alt=""></div>
              </div>
            </div>
          </div>
        ...
        <footer>
          staticmyid © 2019<script>new Date().getFullYear()>2010&&document.write("-"+new Date().getFullYear());</script> <a href="https://cnet.work" target="_blank" rel="noopener noreferrer">Cnetwork</a>.<br>
